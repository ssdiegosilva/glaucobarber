...
export const NAV = [
  { href: "/dashboard",        label: "Dashboard",       icon: LayoutDashboard, key: "dashboard",        desc: "Visão geral do negócio" },
  { href: "/dashboard-vendas", label: "Vendas",          icon: BarChart3,       key: "dashboard-vendas", desc: "KPIs e ranking de produtos" },
  { href: "/agenda",           label: "Agenda",          icon: CalendarDays,    key: "agenda",           desc: "Agendamentos do dia" },
  { href: "/visitas",          label: "Visitas",         icon: ShoppingBag,     key: "visitas",          desc: "Registrar vendas" },
  { href: "/produtos",         label: "Produtos",        icon: Package,         key: "produtos",         desc: "Catálogo de produtos" },
  { href: "/copilot",          label: "Copilot",         icon: Sparkles,        key: "copilot",          desc: "Assistente com IA" },
  { href: "/financeiro",       label: "Financeiro",      icon: TrendingUp,      key: "financeiro",       desc: "Receita e despesas" },
  { href: "/meta",             label: "Metas",           icon: Target,          key: "meta",             desc: "Metas diárias e mensais" },
  { href: "/clients",          label: "Clientes",        icon: Users,           key: "clients",          desc: "Gestão de clientes" },
  { href: "/services",         label: "Serviços",        icon: Scissors,        key: "services",         desc: "Catálogo de serviços" },
  { href: "/ofertas",          label: "Ofertas",         icon: BadgePercent,    key: "targeted-offers",  desc: "Ofertas para clientes" },
  { href: "/campaigns",        label: "Campanhas",       icon: Megaphone,       key: "campaigns",        desc: "Marketing com IA" },
  { href: "/vitrine",          label: "Vitrine",         icon: GalleryHorizontal, key: "vitrine",        desc: "Posts para Instagram" },
  { href: "/criar-visual",     label: "Criar Visual",    icon: Wand2,           key: "criar-visual",     desc: "Sugestão de corte com IA" },
  { href: "/whatsapp",         label: "WhatsApp",        icon: MessageCircle,   key: "whatsapp",         desc: "Mensagens automáticas" },
  { href: "/post-sale",        label: "Pós-venda",       icon: HeartHandshake,  key: "post-sale",        desc: "Follow-up de clientes" },
];
    ...
    <aside className={cn("flex h-screen w-60 flex-col border-r border-border bg-card", className)}>
      ...
      <div className="relative border-b border-border">
        ...
        >
          ...
          <img src="/icon-192.png" alt="Voltaki" className="h-9 w-9 shrink-0 rounded-xl" />
